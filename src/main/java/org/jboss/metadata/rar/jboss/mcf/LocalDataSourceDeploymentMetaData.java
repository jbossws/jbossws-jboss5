...
@XmlType(name="local-tx-datasource", propOrder={"jndiName", "useJavaContext", "connectionUrl", "urlDelimiter", "urlSelectorStrategyClassName",
      ...
      "maxSize", "blockingTimeoutMilliSeconds", "backgroundValidation", "backgroundValidationMillis", "idleTimeoutMinutes",
      "allocationRetry", "allocationRetryWaitMillis", "validateOnMatch", "noTxSeparatePools", "newConnectionSQL", "checkValidConnectionSQL",
